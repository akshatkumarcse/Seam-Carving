...
# Examples:
# python seam_carving.py -resize -im img/mountain_road.jpg -out mountain_road_resize.jpg -dy 20 -dx -200 -vis
...
def backward_energy(im):
    ...
    gradient_mag = np.sqrt(np.sum(xgrad**2, axis=2) + np.sum(ygrad**2, axis=2))

    # vis = visualize(gradient_mag)
